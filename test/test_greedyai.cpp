...
// //     // Give ultra sonic clear view ahead
// //     _ext._response = _ext.init_sonic_clear() + _ext.init_north_1_0() + _ext.init_sonic_clear() + _ext.init_north_1_0() + 
// //         _ext.init_sonic_clear() + _ext.init_north_1_0() + _ext.init_delta(0,-1) +// 1
// //         _ext.init_sonic_clear() + _ext.init_delta(0,-1) + // 2
// //         _ext.init_sonic_clear() + _ext.init_delta(0,-1) + // 3
// //         _ext.init_sonic_clear() + _ext.init_delta(0,-1) + // 4
// //         _ext.init_sonic_clear() + _ext.init_delta(0,-1) + // 5
// //         _ext.init_sonic_clear() + _ext.init_delta(0,-1) + // 6
// //         _ext.init_sonic_clear() + _ext.init_delta(0,-1) + // 7
// //         _ext.init_sonic_clear() + _ext.init_delta(0,-1) + _ext.init_delta(0,-1);
// //     EXPECT_EQ(PSTATE::P_AVAILABLE, gai.calcPath(d)); 
// // }
