...
void EventRunner::timeout(EventHandler* handler) {
    ...
    throw new TimeOutException("timeout error occrred in event runner");
}

// TODO: This method could do with some timeouts.
